...
/***/ "./pages/sign-up/data-access/sign-in-api-service.ts"
/*!**********************************************************!*\
  !*** ./pages/sign-up/data-access/sign-in-api-service.ts ***!
  \**********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   SignInApiService: () => (/* binding */ SignInApiService)\n/* harmony export */ });\nclass SignInApiService {\n    constructor(applicationConfiguration) {\n        this.applicationConfiguration = applicationConfiguration;\n    }\n    async signIn(signIn) {\n        try {\n            const response = await fetch(`${this.applicationConfiguration.apiUrl}/auth/login`, {\n                method: 'POST',\n                body: JSON.stringify(signIn),\n            });\n            if (!response.ok) {\n                const failure = (await response.json());\n                return failure;\n            }\n            const success = (await response.json());\n            return success.data;\n        }\n        catch (error) {\n            console.error(error);\n            return { error: 'Internal server error' };\n        }\n    }\n}\n\n\n//# sourceURL=webpack://online-zoo/./pages/sign-up/data-access/sign-in-api-service.ts?\n}");
